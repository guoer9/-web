...
# installed.
TCL_PREFIX='g:/师生交互软件/.conda\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='g:/师生交互软件/.conda\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='g:/师生交互软件/.conda\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-Ig:/师生交互软件/.conda\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-Lg:/师生交互软件/.conda\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='g:/师生交互软件/.conda\Library\lib\tclstub86.lib'
